...
export default function Contact() {
  ...
  const LINKS = [
    {
      icon: <IconMail size={20} color="#22d3ee" />,
      label: "Email",
    ...
    <section id="contact" ref={ref} className="section-gap" style={{ position: "relative", zIndex: 1 }}>
      <div className="container-main" style={{ maxWidth: 720 }}>
        ...
        <div className="reveal" style={{ marginBottom: 48, textAlign: "center" }}>
          ...
          <p style={{ fontSize: 15, color: "#5a5e6e", maxWidth: 400, margin: "0 auto", lineHeight: 1.7 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }} className="contact-grid">
          {LINKS.map((link) => (
            ...
            >
              ...
              <div>
                <div style={{ fontSize: 11, color: "#4a4e5e", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 4 }}>
                  {link.label}
                </div>
                <div style={{ fontSize: 14, color: "#c9cdd8", fontWeight: 500 }}>
                  {link.value}
                </div>
              </div>
            </a>
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span className="font-display" style={{ fontSize: 13, fontWeight: 600, color: "#1a1d28" }}>
              Akshat Build X
            </span>
          ...
          <div style={{ fontSize: 12, color: "#8b90a3" }}>
